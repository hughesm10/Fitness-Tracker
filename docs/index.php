...
<!--start navbar-->
<div class="topnav">
  <a href="index.html"><img src="https://img.icons8.com/color/96/000000/strength.png" style="width: 40px;"></a>  <!--homepage logo-->
  <a href="dashboard.html"><img src="https://img.icons8.com/material/96/ffffff/dashboard-layout.png" style="width: 40px;"></a>  <!--dashboard tab image-->
  <a href="socialfeed.html"><img src="https://img.icons8.com/ios-filled/100/ffffff/conference-call.png" style="width: 40px;"></a>  <!--social tab image-->
...
<div class="header">
  <img src="../NoFramework/images/8225.jpg">
  <p class="header-text">FITNESS TRACKER</p>
  <p class="sub-text">Track all your fitness needs!</p>
  <input type="button" class="header-button" value="Get Started" onclick="location.href='signup.html';">
</div>
...
<div style="padding: 20px;">
  ...
  <div style="margin-top:64px; padding: 0 8px; text-align: center;">
    ...
    <div style="width: 33%; float: left;">
      <img src="https://img.icons8.com/external-sbts2018-flat-sbts2018/58/000000/external-social-network-social-media-sbts2018-flat-sbts2018.png"/>
      <p style="font-size: 36px;">Social Feed</p>
      <p>Connect and compete with your friends to reach new goals.</p>
    </div>
    <div style="width: 33%; float: left;">
      <img src="https://img.icons8.com/external-flatart-icons-flat-flatarticons/64/000000/external-goals-user-interface-flatart-icons-flat-flatarticons.png"/>
...
<div>
  <img class="bottom-img" src="../NoFramework/images/11101.jpg">
</div>

<!-- Contact Us section -->
<div style="color: black; background-color: #FDBE34; text-align: center; display: inline-block; width: 100%; height: 180px;">
  <div>
    <h3>Conact Us</h3>
    <p>Let's get in touch. Send us a message:</p>
    <input type="button" class="contact-button" value="Contact Us" onclick="location.href='contact.html';">
  </div>
</div>
